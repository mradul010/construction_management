...
REF_DOCTYPE = 'Request For Information'
REPORT_FIELDS = ['rfi_number', 'project', 'drawing', 'revision_number', 'raised_by', 'consultant', 'due_date', 'status']
...
def get_columns():
	...
	if 'Open RFIs' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Open RFIs' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
