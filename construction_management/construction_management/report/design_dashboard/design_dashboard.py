...
REPORT_FIELDS = ['project', 'design_package', 'discipline', 'current_status', 'name', 'revision_number']
BASE_FILTERS = {}
...
def get_columns():
	...
	if 'Design Dashboard' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Design Dashboard' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
...
def get_data(filters):
	...
	if 'Design Dashboard' == "Design Dashboard":
		return get_dashboard_data(db_filters)
	if 'Design Dashboard' == "Drawings by Discipline":
		return grouped_data(db_filters, ["project", "design_package", "discipline", "current_status"])
	if 'Design Dashboard' == "Drawings by Package":
