...
REPORT_FIELDS = ['name', 'project', 'drawing_number', 'drawing_title', 'current_status', 'modified']
BASE_FILTERS = {}
...
def get_columns():
	...
	if 'Drawing Aging' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Drawing Aging' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
