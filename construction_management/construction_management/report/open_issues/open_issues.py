...
REF_DOCTYPE = 'Design Issue'
REPORT_FIELDS = ['issue_no', 'project', 'drawing', 'revision_number', 'priority', 'assigned_to', 'target_date', 'status']
BASE_FILTERS = {'status': ['not in', ['Resolved', 'Closed']]}
...
def get_columns():
	...
	if 'Open Issues' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Open Issues' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
