...
REPORT_FIELDS = ['name', 'project', 'design_package', 'discipline', 'drawing_number', 'drawing_title', 'revision_number', 'revision_date', 'current_status', 'ifc_status', 'ifc_date']
BASE_FILTERS = {}
...
def get_columns():
	...
	if 'Drawing Register' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Drawing Register' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
...
def get_data(filters):
	...
	if 'Drawing Register' == "Design Dashboard":
		return get_dashboard_data(db_filters)
	if 'Drawing Register' == "Drawings by Discipline":
		return grouped_data(db_filters, ["project", "design_package", "discipline", "current_status"])
	if 'Drawing Register' == "Drawings by Package":
