...
REF_DOCTYPE = 'Drawing Review'
REPORT_FIELDS = ['drawing', 'project', 'revision_number', 'review_stage', 'reviewer', 'review_date', 'decision']
BASE_FILTERS = {}
...
def get_columns():
	...
	if 'Review Status' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Review Status' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
