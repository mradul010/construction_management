...
REF_DOCTYPE = 'Design NCR'
REPORT_FIELDS = ['name', 'project', 'drawing', 'revision_number', 'responsible_person', 'status']
...
def get_columns():
	...
	if 'Open NCR' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Open NCR' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
