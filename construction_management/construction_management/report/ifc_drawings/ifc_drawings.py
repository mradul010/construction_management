...
REPORT_FIELDS = ['name', 'project', 'design_package', 'discipline', 'drawing_number', 'drawing_title', 'revision_number', 'revision_date', 'ifc_date', 'ifc_by']
BASE_FILTERS = {'ifc_status': 1}
...
def get_columns():
	...
	if 'IFC Drawings' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'IFC Drawings' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
