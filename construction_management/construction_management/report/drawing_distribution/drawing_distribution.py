...
REF_DOCTYPE = 'Drawing Distribution'
REPORT_FIELDS = ['drawing', 'revision_number', 'project', 'sent_to', 'company', 'department', 'role', 'date', 'received_date', 'status']
BASE_FILTERS = {}
...
def get_columns():
	...
	if 'Drawing Distribution' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Drawing Distribution' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
...
def get_data(filters):
	...
	if 'Drawing Distribution' == "Design Dashboard":
		return get_dashboard_data(db_filters)
	if 'Drawing Distribution' == "Drawings by Discipline":
		return grouped_data(db_filters, ["project", "design_package", "discipline", "current_status"])
	if 'Drawing Distribution' == "Drawings by Package":
