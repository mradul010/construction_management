...
def get_columns():
	...
	if 'Drawings by Package' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Drawings by Package' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
...
def get_data(filters):
	...
	if 'Drawings by Package' == "Design Dashboard":
		return get_dashboard_data(db_filters)
	if 'Drawings by Package' == "Drawings by Discipline":
		return grouped_data(db_filters, ["project", "design_package", "discipline", "current_status"])
	if 'Drawings by Package' == "Drawings by Package":
