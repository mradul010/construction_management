...
REF_DOCTYPE = 'Design Change Request'
REPORT_FIELDS = ['dcr_number', 'project', 'drawing', 'revision_number', 'approval', 'status']
BASE_FILTERS = {'status': ['not in', ['Closed', 'Rejected']]}
...
def get_columns():
	...
	if 'Open DCR' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Open DCR' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
