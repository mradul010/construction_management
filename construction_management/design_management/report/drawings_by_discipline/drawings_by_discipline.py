...
REPORT_FIELDS = ['project', 'design_package', 'discipline', 'current_status', 'name']
BASE_FILTERS = {}
...
def get_columns():
	...
	if 'Drawings by Discipline' == "Drawing Aging":
		columns.append({"label": _("Age Days"), "fieldname": "age_days", "fieldtype": "Int", "width": 90})
	if 'Drawings by Discipline' in ("Drawings by Discipline", "Drawings by Package", "Design Dashboard"):
...
def get_data(filters):
	...
	if 'Drawings by Discipline' == "Design Dashboard":
		return get_dashboard_data(db_filters)
	if 'Drawings by Discipline' == "Drawings by Discipline":
		return grouped_data(db_filters, ["project", "design_package", "discipline", "current_status"])
	if 'Drawings by Discipline' == "Drawings by Package":
